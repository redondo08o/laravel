                    ...
                    <div class="left__container">
                        ...
                        <div class="progress__bar__container">
                            <ul>
                                ...
                                <li id="icon6"><ion-icon name="layers-outline"></ion-icon></li>
                                <li id="icon7"><ion-icon name="pricetag-outline"></ion-icon></li>
                                <li id="icon8"><ion-icon name="mail-outline"></ion-icon></li>
                            </ul>
                        </div>
                    </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="example-text-input" class="form-control-label text-dark">N.o Documento</label>
                                            <input class="form-control" type="number" placeholder="4354">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="example-text-input" class="form-control-label text-dark">Tpo de Documento</label>
